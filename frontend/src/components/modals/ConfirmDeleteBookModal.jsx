...
import './styles/ConfirmDeleteBookModal.css';

const ConfirmDeleteBookModal = ({ open, handleClose, handleConfirm }) => {
  return (
    <Modal open={open} onClose={handleClose}>
        <Box className="delete-book-modal">
            <div className="delete-book-modal-header">
                <div className="delete-book-modal-icon-container">
